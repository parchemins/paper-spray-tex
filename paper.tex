...
\newcommand{\affLSNN}{\small L2SN, University of Nantes\\
  2 rue de la Houssini{\`e}re\\
  BP 92208, 44322 Nantes Cedex 3, France\\
  \url{first.last@univ-nantes.fr}}

\newcommand{\affINRIA}{\small INRIA Bretagne-Atlantique\\
...
\author[1]{Julian Tanke}
\author[1]{Pascal Molli}
\author[1]{Achour Most{\'e}faoui}
\author[2]{Davide Frey}
\affil[1]{\affLSNN}
\affil[2]{\affINRIA}
