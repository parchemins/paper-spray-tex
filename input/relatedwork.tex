...
otherwise, they are allowed to crash/leave). In WebRTC context, the offer
ticket must travel back to its emitter. As consequence, the elements of the
random dissemination path are not allowed to fail until the stamped ticket
travels back. We obtain:
