...
figure~\ref{fig:webrtc}, $p_1$ wants to connect to $p_2$. Therefore, $p_1$
...
instead, $p_2$ functions as temporary signaling service for the two other peers.
Peer $p_1$ pushes an offer ticket to $p_2$.
As $p_2$ is already connected to $p_1$, it forwards the
...
establishes a bidirectional connection with $p_3$.
Notice that if $p_2$
