...
establish its connections. In the context of WebRTC, each random walk
must travel back to finalize the connection establishment as
...
$P_f$ be the probability of either the peer or the link between the
