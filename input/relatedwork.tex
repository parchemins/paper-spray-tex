...
% They have to know \emph{a priori} the maximum network size to set their
...
sampling protocols. % in WebRTC applications.
...
\begin{problem}
  ...
  \item Partial view size: \hfill
    $\forall p_x \in \mathcal{N}^t,\, |\mathcal{P}_x^t| = \mathcal{O} (\ln
    |\mathcal{N}^t|)$      
