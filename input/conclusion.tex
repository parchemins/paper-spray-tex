...
dissemination highly benefits from adaptive neighborhoods. \SPRAY makes building
scalable decentralized applications easy and accessible, without requiring
knowledge about the range of users or their number. As for broadcast, many
topology optimizations (about localization, latency, preferences etc.) rely on
random peer sampling protocol, e.g., the generic algorithms
T-Man~\cite{jelasity2009tman} or Vicinity~\cite{voulgaris2005epidemic}. \SPRAY
allows such protocols to extend their behavior to dynamic neighborhood views.
