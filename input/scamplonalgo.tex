...
\begin{algorithmic}[1]
  ...
  \act
    ...
    \State \textbf{let} $sample \leftarrow getSample(\mathcal{P}\setminus\left\{q\right\}, \left \lceil{|\mathcal{P}|-1\over{2}} \right \rceil) \uplus \left\{\langle p, 0 \rangle\right\}$; 
