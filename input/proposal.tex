...
\begin{figure*}
  \centering
  \subfloat[Figure A][$p2$ executes OnSubs($p1$)]{
    \input{./input/joiningexampleA.tex}}
  \hspace{40pt}
  \subfloat[Figure B][$p2$ calls $fwdSubs(p1)$ on its neighbor]{
    \input{./input/joiningexampleB.tex}}
  \hspace{40pt}
  \subfloat[Figure C][$p3-p6$ execute $fwdSubs(p1)$]{
...
There exists a close relationship between \SPRAY{} and the proactive
...
\begin{figure*}
  ...
  \caption{\label{fig:cyclicexample}Example of the \SPRAY{}'s cyclic
