...
Keeping the global number of arcs constant can force, in some situations,
...
duplicates remains low and does not impact the network connectedness.
...
occurrences of this neighbor in the partial view, and removes all of them. Then,
