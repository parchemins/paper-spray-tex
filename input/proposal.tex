...
similar to those of random graphs. Finally, A peer is able to leave at any time
without giving notice (equivalent to a crash), still the network properties do
not degrade.
...
partial view may contain multiple occurrences of a particular neighbor. In this
...
associate to the neighbor $n$ the age $age$. The multiset allows managing
...
indifferently of the age. The $onFwdSubs$ event is called when a peer receives
