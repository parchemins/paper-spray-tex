...
\begin{tikzpicture}[scale=1.15]
  ...
  \draw[->](5+0*\X, 0*\Y) --node{$\times$} (-5+ 2*\X, 0*\Y); %% 1 -> 2
  \draw[->] (-5+2*\X, 5pt) -- (5+\X, \Y);
  \draw[->,dashed] (5+\X, 2*\Y)to[out=-20,in=110](2*\X, 5pt); %% 6 -> 2
  \draw[->](2*\X,5pt)to[out=160,in=-70](5+1*\X, 2*\Y); %% 2 -> 6
  \draw[->] (-5+2*\X, -5pt) -- (5+\X, -\Y);
  \draw[->] (-5+2*\X, -5pt) -- (5+\X, -2*\Y);

  \draw[->,dashed](0pt,5pt)to[out=70,in=200](-5+\X, 2*\Y); %% 1 -> 6
  \draw[->](-5+\X,2*\Y)to[out=-110,in=20]node{$\times$}(0pt,5pt); %% 6 -> 1
  ...
  \draw[->](-5+\X, 5+2*\Y)to[out=120,in=30]node{$\times$}
  (-10-2*\Y,5+2*\Y); %% 6 -> 9
  
  \draw[->,dashed](-5pt,5pt)--(-10-2*\Y,-5+2*\Y); %% 1 -> 7
