...
\begin{figure}
  \begin{center}
    \subfloat[Figure A] [\label{fig:hardrate} Full message delivery in
    three-phase broadcast.]
    {\includegraphics[width=\SCALE\textwidth]{img/hardrate.eps}}    
    \subfloat[Figure B] [\label{fig:traffic} Outgoing traffic generated by a
