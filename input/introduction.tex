...
connections easy even within complex network environment involving
firewalls, proxies, Net Address Translation (NAT) and mobile
networks. WebRTC opens a new playground to deploy large-scale
distributed applications running in browsers with just
browser-to-browser connection. if peer sampling protocols such as
