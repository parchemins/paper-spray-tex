...
For instance,
\TODO{a mobile phone user might maintain 10 WebRTC connections with other
  remote browsers when only 6 would be enough}. The difference is significant when
these connections are actively used to broadcast messages \TODO{generating
  oversized traffic on the network}.
...
browsers\footnote{\url{http://chat-wane.github.io/CRATE/}} \TODO{on laptops,
tablets and mobile phones}. The experiments run on Grid'5000
