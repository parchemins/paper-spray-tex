...
\TODO{a user on his mobile phone must maintain 10 WebRTC connections with other
  remote browsers when only 6 are enough}. The difference is significant when
