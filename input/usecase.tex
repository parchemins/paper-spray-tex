...
Video streaming has grown in importance over recent years. In such applications, 


\subsubsection{Operation}

Using gossiping, all peers send their messages and incoming messages to all
