...
\item [Results:] Figure~\ref{fig:warmup} and Figure~\ref{fig:traffic} show the
  ...
  traffic would have been higher (see Figure~\ref{fig:churn}). It is important
  since even small partial view size differences significantly impact traffic.
  ...
  between independent runs. Still, \SPRAY scales logarithmically
