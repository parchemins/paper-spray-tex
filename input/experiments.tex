...
rights limited to document reading.  \TODO{We think that real-time editors
  should allow editing at anytime and anywhere, whatever the number of
  participants.}  Real-time editing sessions can be highly dynamic; even if only
...
real-time editor that supports privacy and that adapts \TODO{gently} from small
...
%   \caption{\label{fig:architecture}\CRATE's architecture comprises 4 layers.}
% \end{figure}
