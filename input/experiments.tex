...
\item[Description:] The average path length is the average of the shortest path
  ...
  $100$, $500$, $1000$, $5000$, \ldots, $100000$ peers.
...
\item[Reasons:] We perform all the measurements after convergence where the
  ...
  lower average path length then \SPRAY{}, as soon as it is undersized,
  \SPRAY{} is, thanks to larger partial views, better connected into the graph
  and, consequently, yields the shorter average path length. The overall
...
\begin{figure}
  ...
  \caption{\label{fig:histo}The in-degree distribution of \CYCLON{} and
    ...
    y-axis indicates how much of the network features the given in-degree.}
\end{figure}
