...
\begin{tikzpicture}[scale=1.15]
  ...
  {$spreads$\\$|\mathcal{P}_2|+c$\\$copies$};
  \draw (5pt,-30pt) node[align=left,anchor=north west]
  {$1/2$ $chance$ $to$ $accept,$\\$refuses,$ $forwards$ $to$ $p_4$};
  \draw (5pt, 25pt) node[align=left,anchor=west]
  {$1/2$ $chance$ $to$ $accept,$\\$accepts,$ $creates$ $p_3 \rightarrow p_1$};
  \draw (30pt, 0pt) node[align=left,anchor=west]
  {$1/2$ $chance$ $to$ $accept,$\\$accepts,$ $creates$ $p_4 \rightarrow p_1$};
  \end{scope}
