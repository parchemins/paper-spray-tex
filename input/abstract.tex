...
\begin{abstract}
  ...
  distributed applications running in web browsers. If peer sampling protocols
  can be used to maintain devices connected, they do not adapt to networks that
  ...
  local \TODO{routing} tables the size of which logarithmically scales to the
  real number of \TODO{participants}. Our experiments demonstrate the ability of
  ...
  real-time decentralized editor running in browsers \TODO{on laptops, tablets
    and mobile phones}. We ran experimentation involving uptill 600
