...
\begin{abstract}
  ...
  to networks that can grow or shrink.  As a result, traffic can be oversized.
  ...
  network members. Our experiments demonstrate the ability of \SPRAY to
  adapt to dynamic networks, reducing the number of WebRTC connections needed to
  maintain browsers connected. To validate our proposal, we built a real-time
