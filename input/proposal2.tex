...
growth: a polylogarithmic upper bound on their space complexity compared to the
document size ($\mathcal{O}((\log |document|)^2)$).
...
top of \SPRAY following the principles of epidemic dissemination (also known as
